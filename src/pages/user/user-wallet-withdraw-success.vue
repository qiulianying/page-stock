<template>
	<view class="user-wallet-withdraw-success-page">
		<cu-custom bgColor="bg-white" is-back back-reload>
			<block slot="backText" class="text-black">提现已受理</block>
		</cu-custom>
			...
			<view class="flex">
				...
				<view class="action-text">
					...
					<view class="action-text-item text-center">
						<view style="font-size:32rpx">管理审核中</view>
						<view class="text-gray" style="font-size:24rpx">预计1小时内到账</view>
					</view>
...
<!--				<view class="action-info">
					...
					<text class="action-info-detail">202203301509025651526</text>
				</view>-->
			</view>
			<view class="flex" style="width: 100%; margin-top: 120rpx;">
				<button :style="[{backgroundColor: themeColor, border: 'none'}]" class="cu-btn page-box-btn"  @tap="toReturn">完成</button>
			</view>
		</view>
	</view>
</template>
...
<script>
	export default {
		...
		methods: {
			toReturn() {
				this.$toView('user/user-money', false, true, false)
			}
		},
		async onLoad(option) {
