		...
		<view v-if="visible.page" class="page-box flex flex-direction ">
			...
			<view class="flex">
				<view class="status-box">
					<image class="status-img"
						src="https://spmct.51zcm.cc/platform-oss/internal-getfile/softwareparkweb/manageweb/1638904504000/green_circle.png">
			...
			<!-- <view v-if="appStatus == 5" class="flex">
				<view class="status-box">
					...
					<view class="status-note">{{notice}}</view>
			...
			<view class="flex flex-direction info">
				<view class="action-info">
					<text class="action-info-title">充值成功金额</text>
					<text class="action-info-detail">¥ 0.01</text>
				</view>
				<view class="action-info">
					<text class="action-info-title">创建时间</text>
					<text class="action-info-detail">2022-03-30 17:47:23</text>
				</view>
				<view class="action-info">
					<text class="action-info-title">订单号</text>
					<text class="action-info-detail">20220330174723156</text>
				</view>
			</view>
